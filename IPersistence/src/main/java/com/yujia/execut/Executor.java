...
public interface Executor {
    ...
    default PreparedStatement getpreparedStatement(Configuration configuration, MappedStatement mappedStatement, Object[] param) throws Exception {
        // 获取连接
    ...
    default <T> List<T> parseResult(ResultSet resultSet, Class resultClass) throws Exception {
    ...
    default BoundSql getBoundSql(String sql) {
    ...
    <T> List<T> executeQuery(Configuration configuration, MappedStatement mappedStatement, Object[] param) throws Exception;

    int executeUpdate(Configuration configuration, MappedStatement mappedStatement, Object[] param) throws Exception;
}
